...
public class servicegoogle {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                servicegoogle.class.getResourceAsStream("/client_secret.json");
    ...
    public static String uploaddrive(String filename,String filetype)  throws IOException {
        ...
        //upload to drive
        String folderID="1h1JWDXfM3_NEwjo0S430gjdog9ODXIXu";
        com.google.api.services.drive.model.File  fileMetadata = new com.google.api.services.drive.model.File();
        fileMetadata.setName(filename);
        fileMetadata.setParents(Collections.singletonList(folderID));
        java.io.File filePath = new java.io.File("src/main/webapp/upload/"+filename);
